...
The repository includes [benchmarks/open_data_suite.json](bagx/benchmarks/open_data_suite.json), which covers:
...
It also includes [benchmarks/non_slam_suite.json](bagx/benchmarks/non_slam_suite.json), which focuses on non-SLAM value:

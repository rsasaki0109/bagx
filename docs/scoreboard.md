...
**30 public datasets** tracked · **23 scored** · bagx 0.6.0

| Dataset | Domain | ROS | Overall | IMU | Sync | Key finding | bagx |
|---------|--------|-----|---------|-----|------|-------------|------|
| [EuRoC MH_01_easy](https://projects.asl.ethz.ch/datasets/doku.php?id=kmavvisualinertialdatasets) | SLAM | ros1 | **—** | — | — | Pending download — classic VIO benchmark (ROS1 .bag) | — |
...
| [M2DGR (urban street)](https://github.com/SJTU-ViSYS/M2DGR) | SLAM | ros2 | **—** | — | — | Pending download — multi-sensor GNSS/IMU/LiDAR urban dataset | — |
...
| [UrbanLoco (Alameda)](https://github.com/weisongwen/UrbanLoco) | SLAM | ros1 | **—** | — | — | Pending download — long urban GNSS/IMU/LiDAR sequence | — |
| [UrbanNav HK TST](https://github.com/IPNL-POLYU/UrbanNavDataset) | SLAM | ros1 | **—** | — | — | Pending download — urban canyon GNSS + LiDAR fusion bag | — |
...
| [TurtleBot3 Walker](https://huggingface.co/datasets/okritvik/TurtleBot3_Walker) | Nav2 | ros2 | **—** | — | — | Pending eval — Nav2 Walker bag (odom, scan, cmd_vel) | — |
| [Franka Panda (MoveIt)](https://huggingface.co/datasets/adriankobras/panda) | MoveIt | ros2 | **—** | — | — | Pending eval — Franka Panda MoveIt demonstration bag | — |
